...
A Math Magician is a single page application where you can do simple math calculations.
...
```
git clone your link repo https://github.com/anshuman7negi/math-magicians.git
cd your folder name
```
### Install
